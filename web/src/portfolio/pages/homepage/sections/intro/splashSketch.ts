...
const splashSketch = (p: p5): void => {
  ...
  class Electron {
    ...
    constructor() {
      ...
      this.color = "#6FC3DF";
      this.trailColor = p.random(1) < 0.5 ? "#DF740C" : "#D5EEEE";
      this.radius = 2;
    ...
    update() {
      for (let i = 0; i < this.numSegments - 1; i++) {
        this.xCor[i] = this.xCor[i + 1] || 0;
        this.yCor[i] = this.yCor[i + 1] || 0;
      }

      switch (this.direction) {
        case "up":
          this.xCor[this.numSegments - 1] =
            this.xCor[this.numSegments - 2] || 0;
          this.yCor[this.numSegments - 1] =
            (this.yCor[this.numSegments - 2] || 0) - this.perSegment;
          break;
        case "down":
          this.xCor[this.numSegments - 1] =
            this.xCor[this.numSegments - 2] || 0;
        ...
        case "left":
          this.xCor[this.numSegments - 1] =
            (this.xCor[this.numSegments - 2] || 0) - this.perSegment;
          this.yCor[this.numSegments - 1] =
            this.yCor[this.numSegments - 2] || 0;
          break;
        case "right":
          this.xCor[this.numSegments - 1] =
            (this.xCor[this.numSegments - 2] || 0) + this.perSegment;
