...
pub fn Intro() -> impl IntoView {
    ...
    view! {
        <div class="h-[calc(100%-1.5rem)] py-16 lg:pt-32">
            ...
            <p class="font-body text-md my-12">
                {INTRO.about}
            </p>
...
pub fn Homepage() -> impl IntoView {
    view! {
        <div class="min-h-screen bg-gray-200 dark:bg-gray-800 bg-intro-texture bg-fixed bg-no-repeat bg-cover bg-blend-screen dark:bg-blend-color-dodge">
