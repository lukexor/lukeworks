...
pub fn About() -> impl IntoView {
    view! {
        ...
        <div class="grid gap-12 lg:gap-x-8 lg:grid-cols-[236px_minmax(0,1fr)]">
            <aside>
                // Below `lg` the rail stops being a rail and the column runs the
                // full page width. Without the cap the photo stretches to a
                // thousand pixels wide, and its source is 232px across.
                <div class="flex sticky top-8 flex-col gap-6 lg:max-w-none max-w-64">
                    // No crop and no imposed ratio: the source is a 232x325
                    // portrait, and anything landscape takes the top off a head.
                    <img
                        src="/images/about_me.webp"
                        alt="Luke Petherbridge"
                        width="232"
                        height="325"
                        class="w-full h-auto rounded border border-rule"
                    />
